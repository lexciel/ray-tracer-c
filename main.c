...
/**
    ...
    sphere left_sphere = (hittable*)make_sphere((point3){-R,0,-1}, R, (material*)&material_left);
    sphere right_sphere = (hittable*)make_sphere((point3){R,0,-1}, R, (material*)&material_right);
    */
    ...
    /*
    sphere *main_sphere = (hittable*)make_sphere(&world_mem, (point3){0,0,-1.2}, 0.5, (material*)material_center);
    sphere *ground = (hittable*)make_sphere(&world_mem, (point3){0,-100.5,-1}, 100, (material*)material_ground);
    sphere *left_sphere = (hittable*)make_sphere(&world_mem, (point3){-1,0,-1}, 0.5, (material*)material_left);
    sphere *bubble_sphere = (hittable*)make_sphere(&world_mem, (point3){-1,0,-1}, 0.4, (material*)material_bubble);
    sphere *right_sphere = (hittable*)make_sphere(&world_mem, (point3){1,0,-1}, 0.5, (material*)material_right);
